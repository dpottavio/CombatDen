...
class LopInsurgent: Faction
{
    ...
    class Vehicle
    {
        class SemiArid
        {
            truckAssault     = "LOP_IRA_Landrover_M2";
            truckSupplyAmmo  = "I_G_Van_02_vehicle_F";
            truckSupplyCargo = "LOP_IRA_Truck";
            truckSupplyFuel  = "C_Van_01_fuel_F";
            truckTransport   = "LOP_IRA_Truck";
        };
        class Tropic : SemiArid {};
        class Wood   : SemiArid {};
        class Winter : SemiArid {};
        ...
        class SemiArid : ClimateBase
        {
            class Rifleman : Rifleman
            {
                class Akm : Akm
                {
                    ...
                    unit = "LOP_IRA_Infantry_Rifleman";
            ...
            class Marksman : Marksman
            {
                ...
                {
                    faceware = "G_Balaclava_blk";
                    unit = "LOP_IRA_Infantry_Marksman";
            ...
            class Medic : Medic
            {
                ...
                {
                    faceware = "G_Balaclava_blk";
                    unit = "LOP_IRA_Infantry_Corpsman";
